...
**AI/ML**
LangChain · RAG Systems · MongoDB Vector Search · LangFuse · TensorFlow (predictive neural models, anomaly detection on large imbalanced datasets)

**Backend**
FastAPI · Express.js · TypeScript · Go · PostgreSQL · MongoDB

**Mobile & Frontend**
Vue.js · Kotlin + Jetpack Compose · Flutter

**DevOps & Tools**
Docker · Linux · Git · Shell Scripting · C (embedded systems)
